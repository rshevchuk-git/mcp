import pytest
import re
from awslabs.aws_mcp_server.core.common.errors import CliParsingError, ProhibitedOperatorsError
from awslabs.aws_mcp_server.core.parser.lexer import split_cli_command
