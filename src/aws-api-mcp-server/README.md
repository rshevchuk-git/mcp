...
| `AWS_API_MCP_TELEMETRY` | ❌ No | `"true"` | Allow sending additional telemetry data to AWS related to the server configuration. This includes:<br></br> - call_aws() tool is used with `READ_OPERATIONS_ONLY` set to true or false |
