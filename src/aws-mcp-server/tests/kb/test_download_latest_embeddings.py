...
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.run_command')
...
def test_check_embeddings_file_found():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        embeddings_dir = (
            extracted_dir / 'awslabs' / 'aws_mcp_server' / 'core' / 'data' / 'embeddings'
        )
...
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.check_local_embeddings')
...
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.check_local_embeddings')
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.check_gh_cli')
...
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.check_local_embeddings')
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.check_gh_cli')
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.get_latest_artifact')
...
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.check_gh_cli')
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.get_latest_artifact')
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.download_artifact')
...
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.get_latest_artifact')
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.download_artifact')
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.check_embeddings_file')
def test_try_download_latest_embeddings_no_embeddings_file(
    ...
    with patch(
        'awslabs.aws_mcp_server.scripts.download_latest_embeddings.cleanup'
    ) as mock_cleanup:
        result = try_download_latest_embeddings()
...
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.download_artifact')
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.check_embeddings_file')
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.copy_embeddings_file')
...
@patch('awslabs.aws_mcp_server.scripts.download_latest_embeddings.try_download_latest_embeddings')
def test_main_success(mock_try_download):
    """Test main function with success."""
    mock_try_download.return_value = True

    with patch.object(sys, 'exit') as mock_exit:
        from awslabs.aws_mcp_server.scripts.download_latest_embeddings import main
