...
def read_only_access_policy_version() -> str:
    """Cached version id of the read only access policy."""
    return 'v129'


def read_only_access_policy_document() -> dict:
    """Cached read only access policy document."""
    return {
        'Version': '2012-10-17',
        'Statement': [
            {
